      ...
      <table width="75%" border="0" cellspacing="10">
        ...
        <tr>
          ...
          <td><div class="links" align="center">
            ...
            <p><a href="buyminutes.php">Get Tokens</a> <a href="../../store.php">Store</a> <a href="buyminutes.php">My Account</a> <a href="favorites.php">Followed</a> <a href="updateprofile.php">My Profile</a> <a href="viewsessions.php">My History</a></p>
