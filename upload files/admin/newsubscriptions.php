...
<tr><td><form action="" method="post"><input type="hidden" name="reject" value="1"/><input type="submit" value="Reject all" style="width:175px;background-color:#ff0000;color:#fff;cursor:pointer;padding:5px;margin-top:50px;"></form></td></tr>
  <tr>
    <td><div align="center">
        <?
