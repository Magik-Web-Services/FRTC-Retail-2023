...
$result22 = mysql_query("SELECT * FROM videosessions WHERE model='$model' ORDER BY date DESC");
...
<div class="mainmydiv">
	<div class="mymaindiv">
		<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">	
			<ul id="css3menu1" class="topmenu"><div>
				<li class="topmenu"><a href="paymentop.php"><div style="color:#FFFFFF !important">View Payments</div></a></li>
				
				<li class="topmenu"><a href="showslist.php"><div style="color:#FFFFFF !important">View Show History</div></a></li>
			</div></ul>			
		</table>
		<div class="tip-sections">
		  <?php
			$relt22 = mysql_query("SELECT SUM(cpm), MAX(cpm) FROM videosessions WHERE model='$model' ORDER BY date DESC");
			//$result22 = mysql_query("SELECT * FROM videosessions");
			$row12122 = mysql_fetch_array($relt22);
			//echo "<pre>"; print_r($row12122); echo "</pre>";
			$total_tip = $row12122['SUM(cpm)'];
			$max_tip = $row12122['MAX(cpm)'];
			$relt12202 = mysql_query("SELECT cpm as cptoken, member as latst_tokn_mmbr_nm FROM videosessions WHERE model='$model' ORDER BY date DESC");
			...
			$relt220 = mysql_query("SELECT member FROM videosessions WHERE cpm='$max_tip' ORDER BY date DESC LIMIT 1");			
		...
		?>
		  <ul>
				...
				<li>
					...
					<span><?php echo $member_name; echo " (".$max_tip.")"; ?></span>
				</li>
				<li>
					<strong>Latest Tip Received: </strong> 
					<span><?php echo $latest_tip_member; echo " (".$latest_tip.")"; ?></span>
				</li>					
		  </ul>
	  </div>		
		<div class="newmain">
