...
<br>
				...
				<tr>
					...
					<td align="center">
						...
						<p>
						 <textarea onkeyup="textCounter(this,'counter',1200);" name="welcome" style="width:900px; height:300px; color:#555" ><?=$valueW?>
	</textarea>
					  </p>
						<p>  
...
echo "<a href=\"models.php?page=$pagez\"><div class='pageNumbers'><b>$pagez</b></div></a>"; echo  " ";} 
}
echo "</td></tr>";
}
}
