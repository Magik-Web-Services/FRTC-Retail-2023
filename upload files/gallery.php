...
$result = mysqli_query($conn, "SELECT * FROM chatmodels WHERE user='$_GET[user]' LIMIT 1");
	...
	<tr>
		...
		<td align="center" valign="middle">
			...
			<p><strong><?php echo $tempUser; ?></strong><strong>'s Picture Gallery</strong><br />
				<span class="style3">(click on the thumbnail to open the full size image)</span>
			</p>
			<table width="520" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="center"><?
										...
										$result = mysqli_query($conn, 'SELECT * FROM modelpictures WHERE user="' . $tempUser . '" ORDER BY dateuploaded DESC');
