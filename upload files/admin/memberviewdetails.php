...
if (isset($_POST['Submit3232'])) {
  ...
  $sql = mysqli_query($conn, "UPDATE chatusers set forced_logout='yes' where user='" . $_POST['username'] . "'");
      ...
      <table width="1010" height="102" align="center" cellpadding="10" bgcolor="#FFF" class="form_def">
        ...
        <tr>
          <td width="342" valign="bottom">
            <p><strong class="big_title">Account Holder:&nbsp; <?php echo $tempName ?></strong><br />
          ...
          <td width="490" valign="middle">
            <table width="300" height="96" align="center" cellpadding="5px" cellspacing="">
              <tr align="center">
                <form name="form1" method="post" action="deleteaccount.php">
                  <td height="30">
                    ...
                    <input name="date" type="hidden" id="datds" value="<?php echo $date; ?>">
                  </td>
                </form>
              ...
              <tr>
                ...
                <td height="30" align="center">
                  <input type="submit" name="Submit22" value="<?php if ($status != 'blocked') {
                                                              ...
                                                              } ?> " style="background-color:#ddd !important;cursor:pointer;margin-bottom:-6px;">
                  ...
                  <input name="date" type="hidden" id="daste" value="<?php echo urlencode($date); ?>">
                </td>
                </form>
              </tr>
              <tr align="center">
      ...
      <table width="1010" align="center" cellpadding="10" bgcolor="#F5F5F5" class="form_def">
        <tr>
          ...
          <td width="75%" align="left">
            <p><strong>
                <div style="font-size:20px;color:#669900;"><?php echo $tempMoney; ?></div>
              </strong></p>
          </td>
        </tr>
        ...
        <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr class="form_def">
            ...
            <td width="50%">
              ...
              <input name="id" type="hidden" id="email3" value="<?php echo $tempId; ?>">
            </td>
          </tr>
        </table>
      </form>
        ...
        <table width="50%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr class="form_def">
            ...
            <td width="50%">
              ...
              <input name="username" type="hidden" id="username" value="<?php echo $tempUser; ?>">
              <input name="email" type="hidden" id="email" value="<?php echo $tempEmail; ?>">
              <input name="id" type="hidden" id="id" value="<?php echo $tempId; ?>">
            </td>
          </tr>
        </table>
        <p>&nbsp;</p>
...
<?php
$result = mysqli_query($conn, "SELECT * FROM videosessions WHERE member='$tempUser' ORDER BY date DESC");
if ($_POST['vs']) {
  $result = mysqli_query($conn, "SELECT * FROM videosessions WHERE member='$tempUser' AND model like '%$_POST[vs]%' ORDER BY date DESC");
}
...
if (!$_POST['vs']) {
  $result = mysqli_query($conn, "SELECT * FROM videosessions WHERE member='$tempUser' ORDER BY date DESC LIMIT $start,$perpage");
}
  ...
  if ($total) {
    ...
    foreach ($pages as $pagez) {
      if ($pagez == $page) {
        ...
        echo "<a href=\"$_SERVER[REQUEST_URI]&page=$pagez\"><div class='pageNumbers'><b>$pagez</b></div></a>";
        echo  " ";
      }
    }
    echo "</td></tr>";
