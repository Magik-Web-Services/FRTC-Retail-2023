...
if (!empty($_POST['accountUser']) != "") {
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        if ($_POST['accountUser'] == $tempUser) {
            ...
            //die;
            mysqli_query($conn, "UPDATE $database SET password='$db_password' WHERE id = '$tempId' LIMIT 1");
...
<div class="login_sec_cloud-off">
    <section class="login">
        ...
        <form id="loginform" action="lostpassword.php" method="post" enctype="application/x-www-form-urlencoded" name="form1">
            ...
            <center>
                <div class="login-button" style="text-align:center"><button class="login-button" type="submit" style="text-align:center">Reset</button></div>
            </center>
        </form>
    </section>
</div>
