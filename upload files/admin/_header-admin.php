...
<body>
	...
	mysqli_query($conn, "UPDATE chatmodels SET status='offline' WHERE $nTime-lastupdate>30 AND status!='rejected' AND status!='blocked' AND status!='pending' AND forcedOnline !=1");
	...
	<div align="center" style="background-color:#dfdfdf;margin:0px;position:fixed;width:100%;z-index:9999;">
		<table width="80%" border="0" cellpadding="2">
			...
			<tr>
				...
				<td class="links" align="center" style="padding-right:20px !important;">
					<p><a href="newsubscriptions.php"><i class="fas fa-address-card"></i> Pending <div class="new"><b style="color:#fff !important;"><?php echo $nPending; ?></b></div></a></p>
				</td>
