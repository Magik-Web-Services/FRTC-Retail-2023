...
else if($_POST['Email']!="" && $_POST['gender']!="" && $_POST['Name'] !="" && $_POST['Country'] !="" && $_POST['State'] !="" && $_POST['City'] !=""&& $_POST['ZipCode'] !="" && $_POST['Adress'] !="")
{	 
	include("../../dbase.php");
	$id=$_COOKIE["id"];
	$rult=mysql_query("SELECT user from chatmodels WHERE id='$_COOKIE[id]' LIMIT 1");
	$rwqw = mysql_fetch_array($rult);
	if($username !=""){
		$tempUser=$username;
	}else{
		$tempUser= $rwqw['user'];
...
$sunday=implode('-',$_POST['sunday']);	
	...
	mysql_query("DELETE  from blockedcountry where model='$tempUser' "); 
	//echo $tempUser;
	//die('sdf');
	foreach($_POST['country'] as $cc) {
		$re1lt1 = mysql_query("SELECT * FROM country where country_code='$cc'");
		$r23ow1 = mysql_fetch_object($re1lt1);
		$cuntry_nm = $r23ow1->country_name;		
		mysql_query("INSERT INTO blockedcountry (model,cc,name)values('$tempUser','$cc','$cuntry_nm');");
	}  

	
 
	mysql_query("DELETE from blockedstates where model='$tempUser' "); 
	foreach($_POST['state'] as $cc) {
		$re1lt = mysql_query("SELECT * FROM states where states='$cc'");
		$r23ow = mysql_fetch_object($re1lt);
		$states_cd = $r23ow->states_code;			
		mysql_query("INSERT INTO blockedstates (model,cc,states_code)values('$tempUser','$cc','$states_cd');");
	}  
	    ...
	    <form name="form1" method="post" action="updateprofile.php">
				...
				<div class="col-md-12  profile_infomation_sec_hh informatin_user">
					...
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							...
							<?php 
								$idddd1 = $_COOKIE["id"];
								$resultet1 = mysql_query("SELECT * FROM chatmodels WHERE id='$idddd1'");
								$rowet1 = mysql_fetch_array($resultet1);
								$array1 =  explode(', ', $rowet1['native_language']);
								//echo $array;
								//print_r($array);
							?>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="English" <?php if (in_array('English', $array1, true)) { echo "checked='checked'"; } ?> /> English</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Dutch" <?php if (in_array('Dutch', $array1, true)) { echo "checked='checked'"; } ?> /> Dutch</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="French" <?php if (in_array('French', $array1, true)) { echo "checked='checked'"; } ?> /> French</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Latin" <?php if (in_array('Latin', $array1, true)) { echo "checked='checked'"; } ?> /> Latin</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="German" <?php if (in_array('German', $array1, true)) { echo "checked='checked'"; } ?> /> German</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Italian" <?php if (in_array('Italian', $array1, true)) { echo "checked='checked'"; } ?> /> Italian</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Japanese" <?php if (in_array('Japanese', $array1, true)) { echo "checked='checked'"; } ?> /> Japanese</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Korean" <?php if (in_array('Korean', $array1, true)) { echo "checked='checked'"; } ?> /> Korean</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Portuguese" <?php if (in_array('Portuguese', $array1, true)) { echo "checked='checked'"; } ?> /> Portuguese</li>
								<li><input name="native_language[]" class="native_language" type="checkbox" value="Spanish" <?php if (in_array('Spanish', $array1, true)) { echo "checked='checked'"; } ?> /> Spanish</li>
							</ul>
							<!--select name="L1" id="select2">
								<option value="Dutch"  <?php if ($tL1=="Dutch"){echo "selected";}?> >Dutch</option>
								<option value="English" <?php if ($tL1=="English"){echo "selected";}?> >English</option>
								<option value="French" <?php if ($tL1=="French"){echo "selected";}?> >French</option>
								<option value="German" <?php if ($tL1=="German"){echo "selected";} ?> >German</option>
								<option value="Italian" <?php if ($tL1=="Italian"){echo "selected";} ?> >Italian</option>
								<option value="Japanese" <?php if ($tL1=="Japanese"){echo "selected";} ?> >Japanese</option>
								<option value="Korean" <?php if ($tL1=="Korean"){echo "selected";} ?> >Korean</option>
								<option value="Portuguese" <?php if ($tL1=="Portuguese"){echo "selected";} ?> >Portuguese</option>
								<option value="Spanish" <?php if ($tL1=="Portuguese"){echo "selected";} ?> >Spanish</option>
							</select-->
						</div>
					</div>
					<div class="col-md-2">	
					...
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<select name="Category" id="select">
								...
								{
									if(($row->name=="Most Popular") OR ($row->name=="Phone Chat") OR ($row->name=="Spy Shows")){}else{
					...
					<div class="col-md-10 ">	
						<select name="gender" id="gender">
							<option value='Male' <?php if($tempgender=="Male"){ echo "selected='selected'"; } ?>>Male</option>
							<option value='Female' <?php if($tempgender=="Female"){ echo "selected='selected'"; } ?> >Female</option>
							<option value='TMTOF' <?php if($tempgender=="TMTOF"){ echo "selected='selected'"; } ?> >Trans Male To Female</option>
							<option value='TFTOM' <?php if($tempgender=="TFTOM"){ echo "selected='selected'"; } ?> >Trans Female To Male</option>
						</select>
					</div>
					<div class="col-md-2">
						<p>Race/Ethnicity</p>
					...
					<div class="col-md-10 ">	
						...
						<?php 
						$idddd = $_COOKIE["id"];
						$resultet = mysql_query("SELECT * FROM chatmodels WHERE id='$idddd'");
						$rowet = mysql_fetch_array($resultet);
						...
						?>
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('African-American', $array, true)) { echo "checked='checked'"; } ?> value="African-American"/> African-American</li>
							
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('European', $array, true)) { echo "checked='checked'"; } ?> value="European"/> European</li>
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('Asian/East Asian', $array, true)) { echo "checked='checked'"; } ?> value="Asian/East Asian"/> Asian/East Asian</li>
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('Latin', $array, true)) { echo "checked='checked'"; } ?> value="Latin" /> Latin</li>
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('Pacific Islander', $array, true)) { echo "checked='checked'"; } ?> value="Pacific Islander"/> Pacific Islander</li>						
							<li><input name="race_ethnicity[]" class="race-ethnicity" type="checkbox" <?php if (in_array('White/Caucasian', $array, true)) { echo "checked='checked'"; } ?> value="White/Caucasian"/> White/Caucasian</li>						
						</ul>
					</div>
					<div class="col-md-2">	
					...
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<input name="broadcastplace" type="text" id="broadcastplace" size="24" value="<?php if (isset($tBfrom)){ echo $tBfrom; }  ?>" maxlength="24">
						</div>
					</div>
					<div class="col-md-2">	
					...
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<select name="state[]" multiple class="chosen-select" data-placeholder="Choose states">
								<?php
								$result = mysql_query("SELECT c.*,b.id as status FROM states c left join  (select * from blockedstates where model='$username') b on b.cc=c.states group by states ORDER BY c.states");
			...
			<div class="third_seciton_update">
				...
				<div class="col-md-12 shedule_sec informatin_user">
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Monday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Tuesday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Wednesday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Thursday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Friday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Saturday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Sunday : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
					...
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Do not allow members to chat without tokens:</p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<input type="checkbox" name="whocanchat" id="whocanchat" <?php if($whocanchat=="yes"){ echo "checked='checked'"; } ?>> 
						</div>
					</div>
				<div style="clear:both; margin-top:10px;"><br>
					
					<div class="col-md-2">	
						<label class="first_seciton_left_side"><p>Mask my location : </p></label>
					</div>
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<input type="checkbox" name="makmyloc" id="makmyloc" <?php if($makmyloc=="yes"){ echo "checked='checked'"; } ?>> 
						</div>
					</div></div>
				</div>
			</div>
					...
					<div class="col-md-10">
						<div class="first_seciton_right_side">
							<select name="PMethod" id="PMethod">
								<option value="pp"  <?php if ($tempPMethod=="pp"){echo "selected";} ?> >Paypal</option>
							</select>
						</div>
					</div>	
					<div class="col-md-2">	
