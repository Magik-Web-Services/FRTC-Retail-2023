...
";
	...
	@mail($tOwnerEmail, "Submission approval", "Model:$_POST[username] subscription has been approved, the broadcaster may now login to her account and start broadcasting\r\n$siteurl/login_model.php?user=$_POST[owner]",
     	"MIME-Version: 1.0\r\n".
		 "Content-type: text/plain; charset=iso-8859-1\r\n".
		 "From:'$registrationemail'\r\n".
