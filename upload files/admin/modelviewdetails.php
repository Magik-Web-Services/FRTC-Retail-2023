...
mysql_query("UPDATE chatmodels SET status = 'offline', Spy_Shows = 'no' WHERE user='".$_POST['username']."'");
mysql_query("delete FROM user_logged_in where user='".$_POST['username']."' AND logged_in='yes'");
mysql_query("UPDATE chatmodels set forced_logout='yes' where user='".$_POST['username']."'");
...
include('../dbase.php');
include('../settings.php');
$page_text = $_POST['pay_per_script_html'];
$page_content = addslashes($page_text);
mysql_query("UPDATE chatmodels SET cpm='$_POST[cpm]',scpm='$_POST[scpm]',epercentage='$_POST[epc]',pay_per_mint_script='$_POST[pay_per_mint]',pay_per_script_html='$page_content' $phonechat WHERE id = '$_POST[id]' LIMIT 1");
...
<div align="center">
  <table width="1010" border="0" cellpadding="5">
    <tr>
      <td width="493" style="font-family:Arial, Helvetica, sans-serif;"><h1>Broadcaster Details  </h1></td>
      <td width="491" style="font-family:Arial, Helvetica, sans-serif;"><h1>Broadcaster Private Information</h1></td>
    </tr>
  </table>
</div>
