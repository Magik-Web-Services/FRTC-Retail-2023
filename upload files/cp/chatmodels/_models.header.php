...
<head>
	...
	$result = mysqli_query($conn, "SELECT * from chatusers WHERE id='" . $_COOKIE['id'] . "' LIMIT 1");
			...
			<div class="nav-wrapper">
				<tr>
					<td class="top-right-td" valign="top"><!-- Start css3menu.com BODY section -->
						<ul id="css3menu1" class="topmenu headermaintopleft col-md-3">
							<li class="topmenu col-md-12 col-sm-6">
								<center><a href="index.php"><img src="../../images/logo1.png"></a></center>
							</li>
					...
					if ($_COOKIE['usertype'] == 'chatmodels') {
						$rowws = mysqli_query($conn, "SELECT user,loginkey from chatmodels WHERE id='" . $_COOKIE['id'] . "' LIMIT 1");
						$row = mysqli_fetch_array($rowws);
						$username = $row['user'];
						$freetime = isset($row['freetime']);
						$freetimeexpired = isset($row['freetimeexpired']);

						if ($row['loginkey'] != isset($_SESSION["loginkey"])) {
